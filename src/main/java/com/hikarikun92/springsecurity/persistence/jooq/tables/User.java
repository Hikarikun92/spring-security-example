...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = 1286308738;
    ...
    public Identity<UserRecord, Integer> getIdentity() {
        return Internal.createIdentity(com.hikarikun92.springsecurity.persistence.jooq.tables.User.USER, com.hikarikun92.springsecurity.persistence.jooq.tables.User.USER.ID);
    }

    @Override
    public UniqueKey<UserRecord> getPrimaryKey() {
        return Internal.createUniqueKey(com.hikarikun92.springsecurity.persistence.jooq.tables.User.USER, "user_pkey", com.hikarikun92.springsecurity.persistence.jooq.tables.User.USER.ID);
    }

    @Override
    public List<UniqueKey<UserRecord>> getKeys() {
        return Arrays.<UniqueKey<UserRecord>>asList(
              Internal.createUniqueKey(com.hikarikun92.springsecurity.persistence.jooq.tables.User.USER, "user_pkey", com.hikarikun92.springsecurity.persistence.jooq.tables.User.USER.ID)
            , Internal.createUniqueKey(com.hikarikun92.springsecurity.persistence.jooq.tables.User.USER, "user_username_key", com.hikarikun92.springsecurity.persistence.jooq.tables.User.USER.USERNAME)
        );
    }
